...
<div class="x-body layui-anim layui-anim-up">
    <form class="layui-form jeesns_form" action="${basePath}/teacher/add" method="post" >
        ...
        <div class="layui-form-item">
            <label for="L_teacherCapacity" class="layui-form-label">
                <span class="x-red">*</span>容量
            </label>
            <div class="layui-input-inline">
                <input type="text" id="L_teacherCapacity" name="capacity" data-type="require" class="layui-input">
            </div>
        </div>
