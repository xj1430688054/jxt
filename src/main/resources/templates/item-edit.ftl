...
<div class="x-body layui-anim layui-anim-up">
    <form class="layui-form jeesns_form" action="${basePath}/item/edit/${item.id}" method="post" >
		...
		<div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="name" data-type="require" value="${item.name}" class="layui-input">
            </div>
        </div>
