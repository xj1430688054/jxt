            ...
            <td>
                <#if item.categories??>
                     <#list item.categories as category>
                         ...
                         <#else >
                            <div class="layui-table-cell laytable-cell-1-0-6">
                                <button class="layui-btn layui-btn-primary layui-btn-xs" onclick="x_admin_show('选择教师','/member/order/add/?iid=${item.id}&cid=${category.id}',600,400)">
