...
<div class="x-body">
    ...
    <xblock>
        <button class="layui-btn" onclick="x_admin_show('添加用户','${basePath}/member/add',800,600)"><i class="layui-icon"></i>添加</button>
    ...
    <table class="layui-table">
        ...
        <tr>
            ...
            <td>
                <#if member.state?? && member.state == 0>
            ...
            <td class="td-manage">
                <button class="layui-btn layui-btn layui-btn-xs"  onclick="x_admin_show('编辑','${basePath}/member/edit/${member.id}',800,600)" href="javascript:;">
                    <i class="layui-icon">&#xe642;</i>编辑
                </button>
                <button class="layui-btn-danger layui-btn layui-btn-xs" onclick="member_del(this,'${member.id}')" href="javascript:;">
